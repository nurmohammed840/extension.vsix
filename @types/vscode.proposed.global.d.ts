 ...
 */
/// <reference path="./vscode.global.d.ts" />
...
declare global {
    ...
    interface NotebookCellLanguageChangeEvent {
     ...
     */
    interface NotebookCommunication {
        /**
    ...
    // function registerNotebookKernel(selector: string, kernel: NotebookKernel): Disposable;
    ...
    namespace notebook {
        ...
        function registerNotebookSerializer(notebookType: string, provider: NotebookSerializer, options?: NotebookDocumentContentOptions): Disposable;
    }
    ...
    namespace notebook {
        ...
        // TODO@api use NotebookDocumentFilter instead of just notebookType:string?
        // TODO@API options duplicates the more powerful variant on NotebookContentProvider
        function registerNotebookContentProvider(notebookType: string, provider: NotebookContentProvider,
    ...
    namespace notebook {
         ...
         */
        function createNotebookCellExecutionTask(uri: Uri, index: number, kernelId: string): NotebookCellExecutionTask | undefined;

        const onDidChangeCellExecutionState: Event<NotebookCellExecutionStateChangeEvent>;
    }

    type NotebookFilenamePattern = GlobPattern | { include: GlobPattern; exclude: GlobPattern; };
    ...
    namespace notebook {
        const onDidChangeActiveNotebookKernel: Event<{ document: NotebookDocument, kernel: NotebookKernel | undefined; }>;

        function registerNotebookKernelProvider(selector: NotebookDocumentFilter, provider: NotebookKernelProvider): Disposable;
    }
    ...
    namespace notebook {
        ...
        function createCellStatusBarItem(cell: NotebookCell, alignment?: NotebookCellStatusBarAlignment, priority?: number): NotebookCellStatusBarItem;
    }
    ...
    namespace languages {
         ...
         * @return A [disposable](#Disposable) that unregisters this provider when being disposed.
         */
        function registerInlineHintsProvider(selector: DocumentSelector, provider: InlineHintsProvider): Disposable;
    }
    ...
    */
    namespace test {
         ...
         */
        function registerTestProvider<T extends TestItem>(testProvider: TestProvider<T>): Disposable;
         ...
         */
        function runTests<T extends TestItem>(run: TestRunRequest<T>, token?: CancellationToken): Thenable<void>;
         ...
         */
        function publishTestResult(results: TestRunResult, persist?: boolean): void;
     ...
     */
    interface TestProvider<T extends TestItem = TestItem> {
        /**
     ...
     */
    interface TestRunRequest<T extends TestItem = TestItem> {
        /**
     ...
     */
    interface TestRunOptions<T extends TestItem = TestItem> extends TestRunRequest<T> {
        /**
    ...
    interface TestChildrenCollection<T> extends Iterable<T> {
        /**
     ...
     */
    interface WorkspaceTrustStateChangeEvent {
        /**
    ...
    namespace workspace {
         ...
         */
        const trustState: WorkspaceTrustState;
         ...
         */
        function requestWorkspaceTrust(options?: WorkspaceTrustRequestOptions): Thenable<WorkspaceTrustState | undefined>;

        /**
         * Event that fires when the trust state of the current workspace changes
         */
        const onDidChangeWorkspaceTrustState: Event<WorkspaceTrustStateChangeEvent>;
    }
    ...
    namespace workspace {
         ...
         */
        function registerPortAttributesProvider(portSelector: { pid?: number, portRange?: [number, number], commandMatcher?: RegExp }, provider: PortAttributesProvider): Disposable;
    }
    //#endregion
