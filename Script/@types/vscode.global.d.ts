...
declare global {
    ...
    */
     ...
     */
    type DocumentSelector = DocumentFilter | string | ReadonlyArray<DocumentFilter | string>;
    ...
    namespace tasks {
         ...
         */
        const taskExecutions: ReadonlyArray<TaskExecution>;
 ...
 */
     ...
     * @param T Type of the custom document returned by this provider.
     */
    interface CustomEditorProvider<T extends CustomDocument = CustomDocument> extends CustomReadonlyEditorProvider<T> {
        /**
    ...
    namespace commands {
         ...
         * @return Disposable which unregisters this command on disposal.
         */
        function registerTextEditorCommand(command: string, callback: (textEditor: TextEditor, edit: TextEditorEdit, ...args: any[]) => void, thisArg?: any): Disposable;
    ...
    namespace window {
         ...
         * has changed.
         */
        const onDidChangeVisibleTextEditors: Event<TextEditor[]>;
         ...
         */
        const terminals: ReadonlyArray<Terminal>;
         ...
         * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
         */
        function showInformationMessage<T extends MessageItem>(message: string, ...items: T[]): Thenable<T | undefined>;
         ...
         * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
         */
        function showInformationMessage<T extends MessageItem>(message: string, options: MessageOptions, ...items: T[]): Thenable<T | undefined>;
         ...
         * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
         */
        function showWarningMessage<T extends MessageItem>(message: string, ...items: T[]): Thenable<T | undefined>;
         ...
         * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
         */
        function showWarningMessage<T extends MessageItem>(message: string, options: MessageOptions, ...items: T[]): Thenable<T | undefined>;
         ...
         * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
         */
        function showErrorMessage<T extends MessageItem>(message: string, ...items: T[]): Thenable<T | undefined>;
         ...
         * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
         */
        function showErrorMessage<T extends MessageItem>(message: string, options: MessageOptions, ...items: T[]): Thenable<T | undefined>;
         ...
         * @return A promise that resolves to the selected items or `undefined`.
         */
        function showQuickPick<T extends QuickPickItem>(items: T[] | Thenable<T[]>, options: QuickPickOptions & { canPickMany: true; }, token?: CancellationToken): Thenable<T[] | undefined>;
         ...
         */
        function showQuickPick<T extends QuickPickItem>(items: T[] | Thenable<T[]>, options?: QuickPickOptions, token?: CancellationToken): Thenable<T | undefined>;
         ...
         */
        function showWorkspaceFolderPick(options?: WorkspaceFolderPickOptions): Thenable<WorkspaceFolder | undefined>;
         ...
         */
        function showInputBox(options?: InputBoxOptions, token?: CancellationToken): Thenable<string | undefined>;
         ...
         * @return A disposable which hides the status bar message.
         */
        function setStatusBarMessage(text: string, hideWhenDone: Thenable<any>): Disposable;
         ...
         */
        function withScmProgress<R>(task: (progress: Progress<number>) => Thenable<R>): Thenable<R>;
         ...
         * @return A new Terminal.
         */
        function createTerminal(options: ExtensionTerminalOptions): Terminal;
         ...
         * @return Disposable that unregisters the provider.
         */
        function registerCustomEditorProvider(viewType: string, provider: CustomTextEditorProvider | CustomReadonlyEditorProvider | CustomEditorProvider, options?: {
            /**
    ...
    namespace workspace {
         ...
         */
        const workspaceFile: Uri | undefined;
         ...
         */
        const textDocuments: ReadonlyArray<TextDocument>;
         ...
         */
        function getConfiguration(section?: string | undefined, scope?: ConfigurationScope | null): WorkspaceConfiguration;
    ...
    namespace languages {
         ...
         */
        function match(selector: DocumentSelector, document: TextDocument): number;
         ...
         */
        function getDiagnostics(resource: Uri): Diagnostic[];
         ...
         * @return A [disposable](#Disposable) that unregisters this provider when being disposed.
         */
        function registerOnTypeFormattingEditProvider(selector: DocumentSelector, provider: OnTypeFormattingEditProvider, firstTriggerCharacter: string, ...moreTriggerCharacter: string[]): Disposable;
     ...
     */
    interface SourceControlResourceDecorations extends SourceControlResourceThemableDecorations {
    ...
    type DebugAdapterDescriptor = DebugAdapterExecutable | DebugAdapterServer | DebugAdapterNamedPipeServer | DebugAdapterInlineImplementation;
    ...
    namespace debug {
         ...
         */
        let activeDebugSession: DebugSession | undefined;
         ...
         * @return A [disposable](#Disposable) that unregisters this provider when being disposed.
         */
        function registerDebugConfigurationProvider(debugType: string, provider: DebugConfigurationProvider, triggerKind?: DebugConfigurationProviderTriggerKind): Disposable;
         ...
         */
        function startDebugging(folder: WorkspaceFolder | undefined, nameOrConfiguration: string | DebugConfiguration, parentSessionOrOptions?: DebugSession | DebugSessionOptions): Thenable<boolean>;
    ...
    namespace extensions {
         ...
         */
        function getExtension(extensionId: string): Extension<any> | undefined;
         ...
         */
        const all: ReadonlyArray<Extension<any>>;
    ...
    */
    ...
    namespace authentication {
         ...
         */
        function getSession(providerId: string, scopes: string[], options?: AuthenticationGetSessionOptions): Thenable<AuthenticationSession | undefined>;
